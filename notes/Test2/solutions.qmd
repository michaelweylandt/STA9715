...
\end{align*}$$ From this, we see that $(X, Y, Z)$ follows a multivariate normal distribution with mean $(0, 0, 0)$ and variance
...
We then use the relationship $$\V[\bX] = \V[\bmu + \bA\bZ] = \bA\bV[\bZ]\bA^T = \bA\bI\bA^T = \bA\bA^T$$ to compute the covariance and then correlation directly:
